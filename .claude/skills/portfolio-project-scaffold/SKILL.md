...
4. The 3 KPI tiles and the hero chart.
...
4. `site/src/content/projects/<slug>.mdx` following the page skeleton (takeaway → KPIs → dashboard → Method → Evaluation → Data quality → Build notes → Changelog).
