...
OPTICAL: list[Company] = [
    ...
    _cn("300394.SZ", "T&S Communications", "天孚通信", "optical", "high", share_basis="total"),
    ...
    _cn("603083.SS", "Cambridge Technology", "剑桥科技", "optical", "high", share_basis="total"),
    _cn("301205.SZ", "Lightel", "联特科技", "optical", "high", share_basis="total"),
    _cn("300570.SZ", "Taichen Light", "太辰光", "optical", "high", share_basis="total"),
    _cn("688205.SS", "Dekeli", "德科立", "optical", "high", share_basis="total"),
    _cn("688313.SS", "Sifotech", "仕佳光子", "optical", "high", share_basis="total"),
    ...
    _cn("300620.SZ", "Optolink", "光库科技", "optical", "partial", note="fibre devices, thin-film lithium niobate"),
...
SSB: list[Company] = [
    ...
    _cn("300438.SZ", "Penghui Energy", "鹏辉能源", "ssb", "main", share_basis="total"),
    ...
    _cn("688499.SS", "Leadintelligent", "利元亨", "ssb", "partial", note="battery equipment", share_basis="none",
        share_note="sells production equipment to cell makers"),
