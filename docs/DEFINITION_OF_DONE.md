# Definition of Done — one project page

- [ ] Pipeline green on Actions for 7 consecutive days
- [ ] pandera schemas + business-rule tests + freshness test pass
- [ ] 100% of prose numbers come from `data/facts/<project>.json`; reconciliation test passes
